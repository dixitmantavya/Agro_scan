TOMATO_DISEASE_GUIDE = {

    "Tomato___Early_blight": {
        "symptoms": [
            "Brown spots with concentric ring pattern",
            "Starts from lower/older leaves",
            "Yellowing around spots",
            "Leaves dry and fall off"
        ],
        "cause": "Fungal pathogen (Alternaria solani) surviving in soil and crop debris.",
        "favourable_conditions": "Warm temperatures with high humidity.",
        "spread": "Wind, rain splash, infected debris and tools.",
        "prevention": [
            "Crop rotation",
    ...
    "Tomato___Late_blight": {
        "symptoms": [
            "Large dark brown leaf patches",
            "White fungal growth underside",
            "Rapid leaf and fruit rot"
        ],
        "cause": "Water mold (Phytophthora infestans).",
        "favourable_conditions": "Cool and wet weather.",
        "spread": "Windborne spores and rain splash.",
        "prevention": [
    ...
    "Tomato___Bacterial_spot": {
        ...
        "favourable_conditions": "Warm and humid weather.",
        "spread": "Seeds, water splash, tools.",
        "prevention": [
    ...
    "Tomato___Leaf_Mold": {
        "symptoms": [
            ...
            "Olive-green mold underside"
        ],
        "cause": "Fungus (Passalora fulva).",
        "favourable_conditions": "High humidity.",
    ...
    "Tomato___Septoria_leaf_spot": {
        "symptoms": [
            "Small grey spots with dark border",
            "Black dots inside spots"
        ],
        "cause": "Fungus (Septoria).",
        "favourable_conditions": "Wet warm weather.",
        "spread": "Rain splash.",
    ...
    "Tomato___Spider_mites Two-spotted_spider_mite": {
        ...
        "cause": "Spider mite insect attack.",
        "favourable_conditions": "Hot and dry weather.",
    ...
    "Tomato___Target_Spot": {
        ...
        "cause": "Fungus (Corynespora).",
        "favourable_conditions": "Warm humid weather.",
    ...
    "Tomato___Tomato_Yellow_Leaf_Curl_Virus": {
        ...
        "favourable_conditions": "Warm weather.",
    ...
    "Tomato___Tomato_mosaic_virus": {
        "symptoms": [
            "Mosaic light/dark green patches",
            "Leaf distortion"
        ],
        "cause": "Viral infection via tools and hands.",
        "favourable_conditions": "Handling infected plants.",
